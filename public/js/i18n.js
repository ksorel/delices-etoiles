...
const translations = {
  fr: {
    ...
    rv_choose_menu:      '🍽️ Choisir votre menu (facultatif)',
    rv_back_to_form:     '← Retour à la réservation',
    rv_choosing_menu:    'Choisissez votre menu (facultatif)',
    rv_submit:           '📅 Envoyer la demande',
    rv_sending:          'Envoi…',
    rv_disclaimer:       'Votre demande est envoyée au restaurant, qui vous confirmera par téléphone.',
  ...
  en: {
    ...
    rv_choose_menu:      '🍽️ Choose your menu (optional)',
    rv_back_to_form:     '← Back to reservation',
    rv_choosing_menu:    'Choose your menu (optional)',
    rv_submit:           '📅 Send request',
    rv_sending:          'Sending…',
    rv_disclaimer:       'Your request is sent to the restaurant, which will confirm it by phone.',
